...
def corrupt_mnist() -> tuple[torch.utils.data.Dataset, torch.utils.data.Dataset]:
    ...
    train_images = torch.load(PROJECT_ROOT/"data"/"processed"/"train_images.pt")
    train_target = torch.load(PROJECT_ROOT/"data"/"processed"/"train_target.pt")
    test_images = torch.load(PROJECT_ROOT/"data"/"processed"/"test_images.pt")
    test_target = torch.load(PROJECT_ROOT/"data"/"processed"/"test_target.pt")
